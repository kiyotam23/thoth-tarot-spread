  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "Mode: FATE (PURPLE) / Seed: Gemini (双子座) を 6.Tiphareth にセット",
        "解析のツボ: 情報の伝達・多角的な視点を司る「双子座」をシステムの中心（Hub）に据えます。",
        "3.Binah（土星/構造）に厳しいカードがあれば、情報の受け皿となる「枠組み」が狭すぎて、対話が成立していません。",
        "8.Hod（水星/伝達）との共鳴を見ます。中心にある双子座のエネルギーが、実務レベルのコミュニケーション（8番）でノイズ化していないかデバッグし、情報の交通整理を行います。",
        "【自己管理・メンタル】",
